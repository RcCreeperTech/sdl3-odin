...
HINT_MOUSE_RELATIVE_CLIP_INTERVAL :: "SDL_MOUSE_RELATIVE_CLIP_INTERVAL"
...
HintCallback :: #type proc "c" (userdata: rawptr, name, oldValue, newValue: cstring)
...
foreign lib {
	...
	SetHintWithPriority :: proc(name, value: cstring, priority: HintPriority) -> c.bool ---
	...
	SetHint :: proc(name, value: cstring) -> c.bool ---
	...
	ResetHint :: proc(name: cstring) -> c.bool ---
	...
	GetHintBoolean :: proc(name: cstring, default_value: c.bool) -> c.bool ---
	...
	AddHintCallback :: proc(name: cstring, callback: HintCallback, userdata: rawptr) -> c.bool ---
