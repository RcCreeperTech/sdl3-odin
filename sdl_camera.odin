...
foreign lib {
	...
	GetCameraFormat :: proc(camera: ^Camera, spec: ^CameraSpec) -> c.bool ---
	...
	AcquireCameraFrame :: proc(camera: ^Camera, timestampNS: ^c.uint64_t) -> ^Surface ---
