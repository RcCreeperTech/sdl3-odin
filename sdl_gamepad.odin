...
foreign lib {
	...
	AddGamepadMappingsFromIO :: proc(src: ^IOStream, closeio: c.bool) -> c.int ---
	...
	GetGamepadMappings :: proc(count: ^c.int) -> [^]cstring ---
	...
	SetGamepadMapping :: proc(instance_id: JoystickID, mapping: cstring) -> c.bool ---
	...
	IsGamepad :: proc(instance_id: JoystickID) -> c.bool ---
	...
	GetGamepadVendorForID :: proc(instance_id: JoystickID) -> c.uint16_t ---
	...
	GetGamepadProductForID :: proc(instance_id: JoystickID) -> c.uint16_t ---
	...
	GetGamepadProductVersionForID :: proc(instance_id: JoystickID) -> c.uint16_t ---
	...
	SetGamepadPlayerIndex :: proc(gamepad: ^Gamepad, player_index: c.int) -> c.bool ---
	...
	GetGamepadVendor :: proc(gamepad: ^Gamepad) -> c.uint16_t ---
	...
	GetGamepadProduct :: proc(gamepad: ^Gamepad) -> c.uint16_t ---
	...
	GetGamepadProductVersion :: proc(gamepad: ^Gamepad) -> c.uint16_t ---
	...
	GetGamepadFirmwareVersion :: proc(gamepad: ^Gamepad) -> c.uint16_t ---
	...
	GetGamepadSteamHandle :: proc(gamepad: ^Gamepad) -> c.uint64_t ---
	...
	GamepadConnected :: proc(gamepad: ^Gamepad) -> c.bool ---
	...
	SetGamepadEventsEnabled :: proc(enabled: c.bool) ---
	...
	GetGamepadBindings :: proc(gamepad: ^Gamepad, count: ^int) -> [^]^GamepadBinding ---
	...
	GamepadHasAxis :: proc(gamepad: ^Gamepad, axis: GamepadAxis) -> c.bool ---
	...
	GetGamepadAxis :: proc(gamepad: ^Gamepad, axis: GamepadAxis) -> c.int16_t ---
	...
	GamepadHasButton :: proc(gamepad: ^Gamepad, button: GamepadButton) -> c.bool ---
	...
	GetGamepadButton :: proc(gamepad: ^Gamepad, button: GamepadButton) -> c.bool ---
	...
	GetGamepadTouchpadFinger :: proc(gamepad: ^Gamepad, touchpad, finger: c.int, down: ^c.bool, x, y, pressure: ^c.float) -> c.bool ---
	...
	GamepadHasSensor :: proc(gamepad: ^Gamepad, type: SensorType) -> c.bool ---
	...
	SetGamepadSensorEnabled :: proc(gamepad: ^Gamepad, type: SensorType, enabled: c.bool) -> c.bool ---
	...
	GamepadSensorEnabled :: proc(gamepad: ^Gamepad, type: SensorType) -> c.bool ---
	...
	GetGamepadSensorDataRate :: proc(gamepad: ^Gamepad, type: SensorType) -> c.float ---
	...
	GetGamepadSensorData :: proc(gamepad: ^Gamepad, type: SensorType, data: [^]c.float, num_values: c.int) -> c.bool ---
	...
	RumbleGamepad :: proc(gamepad: ^Gamepad, low_frequency_rumble, high_frequency_rumble: c.uint16_t, duration_ms: c.uint32_t) -> c.bool ---
	...
	RumbleGamepadTriggers :: proc(gamepad: ^Gamepad, left_rumble, right_rumble: c.uint16_t, duration_ms: c.uint32_t) -> c.bool ---
	...
	SetGamepadLED :: proc(gamepad: ^Gamepad, red, green, blue: c.uint8_t) -> c.bool ---
	...
	SendGamepadEffect :: proc(gamepad: ^Gamepad, data: rawptr, size: c.int) -> c.bool ---
