...
VkAllocationCallbacks :: vulkan.AllocationCallbacks
...
foreign lib {
	...
	Vulkan_LoadLibrary :: proc(path: cstring) -> c.bool ---
	...
	Vulkan_GetInstanceExtensions :: proc(count: ^c.uint32_t) -> [^]cstring ---
	...
	Vulkan_CreateSurface :: proc(window: ^Window, instance: VkInstance, allocator: ^VkAllocationCallbacks, surface: ^VkSurfaceKHR) -> c.bool ---


	// Destroy the Vulkan rendering surface of a window.
	//
	// This should be called before DestroyWindow, if Vulkan_CreateSurface
	// was called after CreateWindow.
	//
	...
	Vulkan_DestroySurface :: proc(instance: VkInstance, surface: VkSurfaceKHR, allocator: ^VkAllocationCallbacks) ---
	...
	Vulkan_GetPresentationSupport :: proc(instance: VkInstance, physicalDevice: VkPhysicalDevice, queueFamilyIndex: c.uint32_t) -> c.bool ---
}
